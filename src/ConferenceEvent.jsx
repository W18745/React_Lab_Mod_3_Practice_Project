...
const ConferenceEvent = () => {
    ...
    const handleIncrementAvQuantity = (index) => {
        ...
        console.log(`Incremented ${avItems[index].name} quantity to ${avItems[index].quantity + 1}`);
    };

    const handleDecrementAvQuantity = (index) => {
        dispatch(decrementAvQuantity(index));
        console.log(`Decremented ${avItems[index].name} quantity to ${avItems[index].quantity - 1}`);
    };
